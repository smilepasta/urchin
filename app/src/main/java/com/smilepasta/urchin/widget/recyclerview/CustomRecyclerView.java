...
/**
 * Date: 2018/5/3
 * Desc: https://github.com/TakWolf/Android-HeaderAndFooterRecyclerView
 */
public class CustomRecyclerView extends RecyclerView {
    ...
    public CustomRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyle) {
